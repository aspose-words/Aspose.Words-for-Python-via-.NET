...
class ExParagraph(ApiExampleBase):
    ...
    def test_document_builder_insert_paragraph(self):
        ...
        self.assertEqual(drawing.Color.blue.to_argb(), run_font.color.to_argb())
    ...
    def test_insert_field_after_text_in_paragraph(self):
        ...
        self.assertEqual(f"Hello World!\u0013 DATE \u0014{today}\u0015\r",
            DocumentHelper.get_paragraph_text(doc, 1))
    ...
    def test_insert_field_before_text_in_paragraph_without_update_field(self):
        ...
        self.assertEqual("\u0013 AUTHOR \u0014\u0015Hello World!\r", DocumentHelper.get_paragraph_text(doc, 1))
    ...
    def test_insert_field_after_text_in_paragraph_without_update_field(self):
        ...
        self.assertEqual("Hello World!\u0013 AUTHOR \u0014\u0015\r", DocumentHelper.get_paragraph_text(doc, 1))
    ...
    def test_insert_field_without_separator(self):
        ...
        self.assertEqual("\u0013 LISTNUM \u0015Hello World!\r", DocumentHelper.get_paragraph_text(doc, 1))
    ...
    def test_insert_field_before_run_text(self):
        ...
        self.assertEqual("Hello World!\u0013 AUTHOR \u0014Test Field Value\u0015 Hello World!\r",
            DocumentHelper.get_paragraph_text(doc, 1))
    ...
    def test_insert_field_after_run_text(self):
        ...
        self.assertEqual("Hello World! Hello World!\u0013 AUTHOR \u0014\u0015\r",
            DocumentHelper.get_paragraph_text(doc, 1))
    ...
    def test_insert_field_empty_paragraph_without_update_field(self):
        ...
        self.assertEqual("\u0013 AUTHOR \u0014\u0015\f", DocumentHelper.get_paragraph_text(doc, 1))
    ...
    def test_insert_field_empty_paragraph_with_update_field(self):
        ...
        self.assertEqual("\u0013 AUTHOR \u0014Test Author\u0015\r", DocumentHelper.get_paragraph_text(doc, 0))
    ...
    @staticmethod
    def insert_field_using_field_type(doc: aw.Document, field_type: aw.fields.FieldType, update_field: bool, ref_node: aw.Node,
        is_after: bool, para_index: int):
    ...
    @staticmethod
    def insert_field_using_field_code(doc: aw.Document, field_code: str, ref_node: aw.Node, is_after: bool,
        para_index: int):
    ...
    @staticmethod
    def insert_field_using_field_code_field_string(doc: aw.Document, field_code: str, field_value: str,
        ref_node: aw.Node, is_after: bool, para_index: int):
