...
class ExParagraphFormat(ApiExampleBase):
    ...
    def test_drop_cap(self):
        for drop_cap_position in [aw.DropCapPosition.MARGIN, aw.DropCapPosition.NORMAL, aw.DropCapPosition.NONE]:
            #ExStart
    ...
    def test_paragraph_spacing_and_indents(self):
        ...
        format = doc.first_section.body.first_paragraph.paragraph_format
        self.assertEqual(format.character_unit_left_indent, 10)
        self.assertEqual(format.left_indent, 120)
