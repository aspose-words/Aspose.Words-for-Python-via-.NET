...
class ExInlineStory(ApiExampleBase):
    ...
    def test_position_footnote(self):
        for footnote_position in (aw.notes.FootnotePosition.BENEATH_TEXT, aw.notes.FootnotePosition.BOTTOM_OF_PAGE):
            with self.subTest(footnote_position=footnote_position):
                ...
                self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote contents.', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
    ...
    def test_position_endnote(self):
        for endnote_position in (aw.notes.EndnotePosition.END_OF_DOCUMENT, aw.notes.EndnotePosition.END_OF_SECTION):
            with self.subTest(endnote_position=endnote_position):
                ...
                self.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote contents.', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
    ...
    def test_ref_mark_number_style(self):
        ...
        self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote 1.', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote 2.', doc.get_child(aw.NodeType.FOOTNOTE, 1, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, False, 'Custom footnote reference mark', 'Custom footnote reference mark Footnote 3.', doc.get_child(aw.NodeType.FOOTNOTE, 2, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 1.', doc.get_child(aw.NodeType.FOOTNOTE, 3, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 2.', doc.get_child(aw.NodeType.FOOTNOTE, 4, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.ENDNOTE, False, 'Custom endnote reference mark', 'Custom endnote reference mark Endnote 3.', doc.get_child(aw.NodeType.FOOTNOTE, 5, True).as_footnote())
    ...
    def test_numbering_rule(self):
        ...
        self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote 1.', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote 2.', doc.get_child(aw.NodeType.FOOTNOTE, 1, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote 3.', doc.get_child(aw.NodeType.FOOTNOTE, 2, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote 4.', doc.get_child(aw.NodeType.FOOTNOTE, 3, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 1.', doc.get_child(aw.NodeType.FOOTNOTE, 4, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 2.', doc.get_child(aw.NodeType.FOOTNOTE, 5, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 3.', doc.get_child(aw.NodeType.FOOTNOTE, 6, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 4.', doc.get_child(aw.NodeType.FOOTNOTE, 7, True).as_footnote())
    ...
    def test_start_number(self):
        ...
        self.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 1.', doc.get_child(aw.NodeType.FOOTNOTE, 3, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 2.', doc.get_child(aw.NodeType.FOOTNOTE, 4, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 3.', doc.get_child(aw.NodeType.FOOTNOTE, 5, True).as_footnote())
    ...
    def test_add_footnote(self):
        ...
        self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote text. More text added by a DocumentBuilder.', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, False, 'RefMark', 'Footnote text.', doc.get_child(aw.NodeType.FOOTNOTE, 1, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote text.', doc.get_child(aw.NodeType.FOOTNOTE, 2, True).as_footnote())
    ...
    def test_footnote_endnote(self):
        ...
        self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote text, will appear at the bottom of the page that contains the referenced text.', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
        self.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote text, will appear at the very end of the document.', doc.get_child(aw.NodeType.FOOTNOTE, 1, True).as_footnote())
    ...
    def test_insert_inline_story_nodes(self):
        ...
        self.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', '', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
