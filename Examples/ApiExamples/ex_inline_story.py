...
class ExInlineStory(ApiExampleBase):
    ...
    def test_position_footnote(self):
        for footnote_position in [aw.notes.FootnotePosition.BENEATH_TEXT, aw.notes.FootnotePosition.BOTTOM_OF_PAGE]:
            ...
            #ExEnd
            doc = aw.Document(file_name=ARTIFACTS_DIR + 'InlineStory.PositionFootnote.docx')
            self.assertEqual(footnote_position, doc.footnote_options.position)
            test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote contents.', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())

    def test_position_endnote(self):
        for endnote_position in [aw.notes.EndnotePosition.END_OF_DOCUMENT, aw.notes.EndnotePosition.END_OF_SECTION]:
            #ExStart
            ...
            #ExEnd
            doc = aw.Document(file_name=ARTIFACTS_DIR + 'InlineStory.PositionEndnote.docx')
            self.assertEqual(endnote_position, doc.endnote_options.position)
            test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote contents.', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
    ...
    def test_ref_mark_number_style(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'InlineStory.RefMarkNumberStyle.docx')
        ...
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote 1.', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote 2.', doc.get_child(aw.NodeType.FOOTNOTE, 1, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, False, 'Custom footnote reference mark', 'Custom footnote reference mark Footnote 3.', doc.get_child(aw.NodeType.FOOTNOTE, 2, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 1.', doc.get_child(aw.NodeType.FOOTNOTE, 3, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 2.', doc.get_child(aw.NodeType.FOOTNOTE, 4, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.ENDNOTE, False, 'Custom endnote reference mark', 'Custom endnote reference mark Endnote 3.', doc.get_child(aw.NodeType.FOOTNOTE, 5, True).as_footnote())
    ...
    def test_numbering_rule(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'InlineStory.NumberingRule.docx')
        ...
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote 1.', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote 2.', doc.get_child(aw.NodeType.FOOTNOTE, 1, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote 3.', doc.get_child(aw.NodeType.FOOTNOTE, 2, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote 4.', doc.get_child(aw.NodeType.FOOTNOTE, 3, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 1.', doc.get_child(aw.NodeType.FOOTNOTE, 4, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 2.', doc.get_child(aw.NodeType.FOOTNOTE, 5, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 3.', doc.get_child(aw.NodeType.FOOTNOTE, 6, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 4.', doc.get_child(aw.NodeType.FOOTNOTE, 7, True).as_footnote())
    ...
    def test_start_number(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'InlineStory.StartNumber.docx')
        self.assertEqual(1, doc.footnote_options.start_number)
        ...
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 1.', doc.get_child(aw.NodeType.FOOTNOTE, 3, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 2.', doc.get_child(aw.NodeType.FOOTNOTE, 4, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote 3.', doc.get_child(aw.NodeType.FOOTNOTE, 5, True).as_footnote())
    ...
    def test_add_footnote(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'InlineStory.AddFootnote.docx')
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote text. More text added by a DocumentBuilder.', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, False, 'RefMark', 'Footnote text.', doc.get_child(aw.NodeType.FOOTNOTE, 1, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote text.', doc.get_child(aw.NodeType.FOOTNOTE, 2, True).as_footnote())
    ...
    def test_footnote_endnote(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'InlineStory.FootnoteEndnote.docx')
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', 'Footnote text, will appear at the bottom of the page that contains the referenced text.', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.ENDNOTE, True, '', 'Endnote text, will appear at the very end of the document.', doc.get_child(aw.NodeType.FOOTNOTE, 1, True).as_footnote())
    ...
    def test_insert_inline_story_nodes(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'InlineStory.InsertInlineStoryNodes.docx')
        footnote = doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote()
        test_util.TestUtil.verify_footnote(aw.notes.FootnoteType.FOOTNOTE, True, '', '', doc.get_child(aw.NodeType.FOOTNOTE, 0, True).as_footnote())
        self.assertEqual('Arial', footnote.font.name)
        self.assertEqual(aspose.pydrawing.Color.green.to_argb(), footnote.font.color.to_argb())
        comment = doc.get_child(aw.NodeType.COMMENT, 0, True).as_comment()
        self.assertEqual('My comment.', comment.to_string(save_format=aw.SaveFormat.TEXT).strip())