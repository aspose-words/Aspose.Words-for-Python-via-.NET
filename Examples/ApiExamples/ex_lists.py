...
class ExLists(ApiExampleBase):
    ...
    def test_apply_default_bullets_and_numbers(self):
        ...
        self.verify_list_level('\x00.', 18.0, aw.NumberStyle.ARABIC, doc.lists[1].list_levels[0])
        self.verify_list_level('\x01.', 54.0, aw.NumberStyle.LOWERCASE_LETTER, doc.lists[1].list_levels[1])
    ...
    def test_specify_list_level(self):
        ...
        self.verify_list_level('\x00.', 18.0, aw.NumberStyle.ARABIC, doc.lists[0].list_levels[0])
    ...
    def test_nested_lists(self):
        ...
        self.verify_list_level('\x00)', 0.0, aw.NumberStyle.ARABIC, doc.lists[0].list_levels[0])
        self.verify_list_level('\x00.', 18.0, aw.NumberStyle.ARABIC, doc.lists[1].list_levels[0])
    ...
    def test_create_custom_list(self):
        ...
        self.verify_list_level('\x00', -36.0, aw.NumberStyle.ORDINAL_TEXT, list_level)
    ...
    def test_restart_numbering_using_list_copy(self):
        ...
        list1 = doc.lists[0]
        self.verify_list_level('\x00)', 18.0, aw.NumberStyle.ARABIC, list1.list_levels[0])
        ...
        list2 = doc.lists[1]
        self.verify_list_level('\x00)', 18.0, aw.NumberStyle.ARABIC, list2.list_levels[0])
    ...
    def test_create_and_use_list_style(self):
        ...
        list3 = doc.lists[2]
        self.verify_list_level('\x00.', 18.0, aw.NumberStyle.ARABIC, list3.list_levels[0])
    ...
    def test_create_list_restart_after_higher(self):
        ...
        list_level = doc.lists[0].list_levels[0]
        self.verify_list_level('Appendix \x00', 18.0, aw.NumberStyle.UPPERCASE_LETTER, list_level)
        ...
        list_level = doc.lists[0].list_levels[1]
        self.verify_list_level('Section (\x00.\x01)', 54.0, aw.NumberStyle.LEADING_ZERO, list_level)
