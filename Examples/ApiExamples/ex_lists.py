...
class ExLists(ApiExampleBase):
    ...
    def test_remove_tab_stop_from_list_level(self):
        #ExStart:RemoveTabStopFromListLevel
        #ExFor:ListLevel.remove_tab_stop()
        ...
        doc = aw.Document(file_name=ARTIFACTS_DIR + "Paragraph.RemoveTabStopFromListLevel.docx")
        effective_list_level = doc.first_section.body.first_paragraph.list_format.list_level
        self.assertIsNotNone(effective_list_level)
