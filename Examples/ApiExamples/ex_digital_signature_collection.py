...
class ExDigitalSignatureCollection(ApiExampleBase):
    ...
    def test_get_enumerator(self):
        ...
        self.assertEqual('CN=VeriSign Class 3 Code Signing 2009-2 CA, ' + 'OU=Terms of use at https://www.verisign.com/rpa (c)09, ' + 'OU=VeriSign Trust Network, ' + 'O="VeriSign, Inc.", ' + 'C=US', signature.issuer_name)
        self.assertEqual('CN=Aspose Pty Ltd, ' + 'OU=Digital ID Class 3 - Microsoft Software Validation v2, ' + 'O=Aspose Pty Ltd, ' + 'L=Lane Cove, ' + 'S=New South Wales, ' + 'C=AU', signature.subject_name)