...
class TestUtil(object):
    ...
    @staticmethod
    def verify_image(expected_width: int, expected_height: int, filename: Optional[str]=None, image_stream: Optional[io.BytesIO]=None):
    ...
    @staticmethod
    def verify_shape(expected_shape_type: aw.drawing.ShapeType, expected_name: str, expected_width: float, expected_height: float, expected_top: float, expected_left: float, shape: aw.drawing.Shape):
    ...
    @staticmethod
    def verify_field(expected_type: aw.fields.FieldType, expected_field_code: str, expected_result: str, field: aw.fields.Field):
    ...
    @staticmethod
    def verify_image_in_shape(expected_width: int, expected_height: int, expected_image_type: aw.drawing.ImageType, image_shape: aw.drawing.Shape):
    ...
    @staticmethod
    def verify_tab_stop(expected_position: float, expected_tab_alignment: aw.TabAlignment, expected_tab_leader: aw.TabLeader, is_clear: bool, tab_stop: aw.TabStop):
    ...
    @staticmethod
    def verify_text_box(expected_layout_flow: aw.drawing.LayoutFlow, expected_fit_shape_to_text: bool, expected_text_box_wrap_mode: aw.drawing.TextBoxWrapMode, margin_top: float, margin_bottom: float, margin_left: float, margin_right: float, text_box: aw.drawing.TextBox):
    ...
    @staticmethod
    def verify_footnote(expected_footnote_type: aw.notes.FootnoteType, expected_is_auto: bool, expected_reference_mark: str, expected_contents: str, footnote: aw.notes.Footnote):
    ...
    @staticmethod
    def verify_list_level(expected_list_format: str, expected_number_position: float, expected_number_style: aw.NumberStyle, list_level: aw.lists.ListLevel):
    ...
    @staticmethod
    def verify_editable_range(expected_id: int, expected_editor_user: str, expected_editor_group: aw.EditorType, editable_range: aw.EditableRange):
