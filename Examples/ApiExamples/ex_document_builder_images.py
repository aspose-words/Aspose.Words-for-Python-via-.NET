...
class ExDocumentBuilderImages(ApiExampleBase):
    ...
    def test_insert_image_from_image_object(self):
        ...
        builder.insert_break(aw.BreakType.PAGE_BREAK)
        # 3 -  Floating shape with custom dimensions:
        builder.insert_image(image, aw.drawing.RelativeHorizontalPosition.MARGIN, 100, aw.drawing.RelativeVerticalPosition.MARGIN, 100, 200, 100, aw.drawing.WrapType.SQUARE)
