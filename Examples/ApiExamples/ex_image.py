...
class ExImage(ApiExampleBase):
    ...
    def test_from_image(self):
        ...
        with drawing.Image.from_file(IMAGE_DIR + "Logo.jpg") as raster_image:
            builder.write("Raster image: ")
            builder.insert_image(raster_image)
            builder.writeln()

        with drawing.Image.from_file(IMAGE_DIR + "Windows MetaFile.wmf") as metafile:
            builder.write("Metafile: ")
            builder.insert_image(metafile)
            builder.writeln()

        builder.document.save(ARTIFACTS_DIR + "Image.from_image.docx")
