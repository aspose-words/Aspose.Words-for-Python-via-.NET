...
class ExOdtSaveOptions(ApiExampleBase):
    ...
    def test_measurement_units(self):
        ...
        for odt_save_measure_unit in (aw.saving.OdtSaveMeasureUnit.CENTIMETERS,
                                      aw.saving.OdtSaveMeasureUnit.INCHES):
            with self.subTest(odt_save_measure_unit=odt_save_measure_unit):
                ...
                if odt_save_measure_unit == aw.saving.OdtSaveMeasureUnit.CENTIMETERS:
                    TestUtil.doc_package_file_contains_string(
                        ...
                        ARTIFACTS_DIR + "OdtSaveOptions.odt11_schema.odt", "styles.xml")
