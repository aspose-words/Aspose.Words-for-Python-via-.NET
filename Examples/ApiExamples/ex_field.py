...
class ExField(ApiExampleBase):
    ...
    def test_rev_num(self):
        ...
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_REVISION_NUM, expected_field_code=' REVNUM ', expected_result='2', field=doc.range.fields[0])
    ...
    def test_insert_field_none(self):
        ...
        #ExEnd
        doc = document_helper.DocumentHelper.save_open(doc)
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_NONE, expected_field_code=' NOTAREALFIELD //a', expected_result='Error! Bookmark not defined.', field=doc.range.fields[0])
    ...
    def test_field_compare(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.COMPARE.docx')
        field = doc.range.fields[0].as_field_compare()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_COMPARE, expected_field_code=' COMPARE  3 < 2', expected_result='0', field=field)
        ...
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_COMPARE, expected_field_code=' COMPARE  5 = "2 + 3"', expected_result='1', field=field)
    ...
    def test_field_if(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.IF.docx')
        field = doc.range.fields[0].as_field_if()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_IF, expected_field_code=' IF  0 = 1 True False', expected_result='False', field=field)
        ...
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_IF, expected_field_code=' IF  5 = "2 + 3" True False', expected_result='True', field=field)
        self.assertEqual('5', field.left_expression)
        self.assertEqual('=', field.comparison_operator)
        self.assertEqual('"2 + 3"', field.right_expression)
        self.assertEqual('True', field.true_text)
    ...
    def test_field_auto_text(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.AUTOTEXT.GLOSSARY.dotx')
        self.assertEqual(0, len(doc.field_options.built_in_templates_paths))
        field_auto_text = doc.range.fields[0].as_field_auto_text()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_AUTO_TEXT, expected_field_code=' AUTOTEXT  MyBlock', expected_result='Hello World!\r', field=field_auto_text)
    ...
    def test_field_list_num(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.LISTNUM.docx')
        self.assertEqual(7, doc.range.fields.count)
        field = doc.range.fields[0].as_field_list_num()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_LIST_NUM, expected_field_code=' LISTNUM  \\s 0', expected_result='', field=field)
        ...
        while i < 4:
            ...
            test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_LIST_NUM, expected_field_code=' LISTNUM ', expected_result='', field=field)
        ...
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_LIST_NUM, expected_field_code=' LISTNUM  \\l 2', expected_result='', field=field)
        self.assertIsNone(field.starting_number)
        self.assertEqual('2', field.list_level)
        self.assertFalse(field.has_list_name)
        self.assertIsNone(field.list_name)
        field = doc.range.fields[5].as_field_list_num()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_LIST_NUM, expected_field_code=' LISTNUM  OutlineDefault \\s 1', expected_result='', field=field)
    ...
    def test_toc_seq_prefix(self):
        ...
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_SEQUENCE, expected_field_code=' SEQ PrefixSequence _Toc256000000 \\* ARABIC ', expected_result='1', field=field_seq)
        ...
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_SEQUENCE, expected_field_code=' SEQ PrefixSequence _Toc256000001 \\* ARABIC ', expected_result='2', field=field_seq)
        self.assertEqual('PrefixSequence', field_seq.sequence_identifier)
        field_page_ref = doc.range.fields[4].as_field_page_ref()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_PAGE_REF, expected_field_code=' PAGEREF _Toc256000001 \\h ', expected_result='3', field=field_page_ref)
        self.assertEqual('PrefixSequence', field_seq.sequence_identifier)
        self.assertEqual('_Toc256000001', field_page_ref.bookmark_name)
        field_seq = doc.range.fields[5].as_field_seq()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_SEQUENCE, expected_field_code=' SEQ  PrefixSequence', expected_result='1', field=field_seq)
        self.assertEqual('PrefixSequence', field_seq.sequence_identifier)
        field_seq = doc.range.fields[6].as_field_seq()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_SEQUENCE, expected_field_code=' SEQ  MySequence', expected_result='1', field=field_seq)
        self.assertEqual('MySequence', field_seq.sequence_identifier)
        field_seq = doc.range.fields[7].as_field_seq()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_SEQUENCE, expected_field_code=' SEQ  PrefixSequence', expected_result='2', field=field_seq)
        self.assertEqual('PrefixSequence', field_seq.sequence_identifier)
        field_seq = doc.range.fields[8].as_field_seq()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_SEQUENCE, expected_field_code=' SEQ  MySequence', expected_result='2', field=field_seq)
        self.assertEqual('MySequence', field_seq.sequence_identifier)
    ...
    def test_toc_seq_numbering(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.SEQ.ResetNumbering.docx')
        self.assertEqual(4, doc.range.fields.count)
        field_seq = doc.range.fields[0].as_field_seq()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_SEQUENCE, expected_field_code=' SEQ  MySequence \\r 100', expected_result='100', field=field_seq)
        self.assertEqual('MySequence', field_seq.sequence_identifier)
        field_seq = doc.range.fields[1].as_field_seq()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_SEQUENCE, expected_field_code=' SEQ  MySequence', expected_result='101', field=field_seq)
        self.assertEqual('MySequence', field_seq.sequence_identifier)
        field_seq = doc.range.fields[2].as_field_seq()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_SEQUENCE, expected_field_code=' SEQ  MySequence \\s 1', expected_result='1', field=field_seq)
        self.assertEqual('MySequence', field_seq.sequence_identifier)
        field_seq = doc.range.fields[3].as_field_seq()
    ...
    def test_field_barcode(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.BARCODE.docx')
        self.assertEqual(0, doc.get_child_nodes(aw.NodeType.SHAPE, True).count)
        field = doc.range.fields[0].as_field_barcode()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_BARCODE, expected_field_code=' BARCODE  96801 \\u \\f C', expected_result='', field=field)
    ...
    def test_field_user_address(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.USERADDRESS.docx')
        field_user_address = doc.range.fields[0].as_field_user_address()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_USER_ADDRESS, expected_field_code=' USERADDRESS  "456 North Road"', expected_result='456 North Road', field=field_user_address)
    ...
    def test_field_user_initials(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.USERINITIALS.docx')
        field_user_initials = doc.range.fields[0].as_field_user_initials()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_USER_INITIALS, expected_field_code=' USERINITIALS  "J. C."', expected_result='J. C.', field=field_user_initials)
    ...
    def test_field_user_name(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.USERNAME.docx')
    ...
    def test_field_author(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.AUTHOR.docx')
        self.assertIsNone(doc.field_options.default_document_author)
        self.assertEqual('Jane Doe', doc.built_in_document_properties.author)
        field = doc.range.fields[0].as_field_author()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_AUTHOR, expected_field_code=' AUTHOR  "Jane Doe"', expected_result='Jane Doe', field=field)
    ...
    def test_field_subject(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.SUBJECT.docx')
        self.assertEqual('My new subject', doc.built_in_document_properties.subject)
        field = doc.range.fields[0].as_field_subject()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_SUBJECT, expected_field_code=' SUBJECT  "My new subject"', expected_result='My new subject', field=field)
    ...
    def test_field_comments(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.COMMENTS.docx')
        ...
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_COMMENTS, expected_field_code=' COMMENTS  "My overriding comment."', expected_result='My overriding comment.', field=field)
    ...
    def test_field_file_size(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.FILESIZE.docx')
        field = doc.range.fields[0].as_field_file_size()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_FILE_SIZE, expected_field_code=' FILESIZE ', expected_result='18105', field=field)
        # These fields will need to be updated to produce an accurate result.
        doc.update_fields()
        field = doc.range.fields[1].as_field_file_size()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_FILE_SIZE, expected_field_code=' FILESIZE  \\k', expected_result='13', field=field)
        self.assertTrue(field.is_in_kilobytes)
        field = doc.range.fields[2].as_field_file_size()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_FILE_SIZE, expected_field_code=' FILESIZE  \\m', expected_result='0', field=field)
    ...
    def test_field_go_to_button(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.GOTOBUTTON.docx')
    ...
    def test_field_info(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.INFO.docx')
        self.assertEqual('New comment', doc.built_in_document_properties.comments)
        field = doc.range.fields[0].as_field_info()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_INFO, expected_field_code=' INFO  Comments', expected_result='My comment', field=field)
        self.assertEqual('Comments', field.info_type)
        field = doc.range.fields[1].as_field_info()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_INFO, expected_field_code=' INFO  Comments "New comment"', expected_result='New comment', field=field)
        self.assertEqual('Comments', field.info_type)
    ...
    def test_field_macro_button(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.MACROBUTTON.docm')
        field = doc.range.fields[0].as_field_macro_button()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_MACRO_BUTTON, expected_field_code=' MACROBUTTON  MyMacro Double click to run macro: MyMacro', expected_result='', field=field)
        ...
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_MACRO_BUTTON, expected_field_code=' MACROBUTTON  ViewZoom200 Run ViewZoom200', expected_result='', field=field)
    ...
    def test_field_keywords(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.KEYWORDS.docx')
        self.assertEqual('OverridingKeyword', doc.built_in_document_properties.keywords)
    ...
    def test_field_num(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.NUMCHARS.NUMWORDS.NUMPAGES.PAGE.docx')
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_NUM_CHARS, expected_field_code=' NUMCHARS ', expected_result='6009', field=doc.range.fields[0])
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_NUM_WORDS, expected_field_code=' NUMWORDS ', expected_result='1054', field=doc.range.fields[1])
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_PAGE, expected_field_code=' PAGE ', expected_result='6', field=doc.range.fields[2])
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_NUM_PAGES, expected_field_code=' NUMPAGES ', expected_result='6', field=doc.range.fields[3])
    ...
    def test_field_print(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.PRINT.docx')
        field = doc.range.fields[0].as_field_print()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_PRINT, expected_field_code=' PRINT  erasepage \\p para', expected_result='', field=field)
    ...
    def test_field_set_ref(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.SET.REF.docx')
        self.assertEqual('Hello world!', doc.range.bookmarks[0].text)
        field_set = doc.range.fields[0].as_field_set()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_SET, expected_field_code=' SET  MyBookmark "Hello world!"', expected_result='Hello world!', field=field_set)
        self.assertEqual('MyBookmark', field_set.bookmark_name)
        self.assertEqual('Hello world!', field_set.bookmark_text)
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_REF, expected_field_code=' REF  MyBookmark', expected_result='Hello world!', field=field_ref)
        self.assertEqual('Hello world!', field_ref.result)
    ...
    def test_field_title(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.TITLE.docx')
        self.assertEqual('My New Title', doc.built_in_document_properties.title)
        field = doc.range.fields[0].as_field_title()
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_TITLE, expected_field_code=' TITLE ', expected_result='My New Title', field=field)
    ...
    def test_field_add_in(self):
        ...
        #ExEnd
        doc = document_helper.DocumentHelper.save_open(doc)
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_ADDIN, expected_field_code=' ADDIN "My value" ', expected_result='', field=doc.range.fields[0])
    ...
    def test_field_formula(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.FORMULA.docx')
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_FORMULA, expected_field_code=' = 2 * 5 ', expected_result='10', field=doc.range.fields[0])
    ...
    def test_field_last_saved_by(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.LASTSAVEDBY.docx')
        self.assertEqual('John Doe', doc.built_in_document_properties.last_saved_by)
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_LAST_SAVED_BY, expected_field_code=' LASTSAVEDBY ', expected_result='John Doe', field=doc.range.fields[0])
    ...
    def test_field_ocx(self):
        ...
        #ExEnd
        test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_OCX, expected_field_code=' OCX ', expected_result='', field=field)
    ...
    def test_field_section(self):
        ...
        #ExEnd
        doc = aw.Document(file_name=ARTIFACTS_DIR + 'Field.SECTION.SECTIONPAGES.docx')
    ...
    def test_bidi_outline(self):
        ...
        for field_bidi_outline in doc.range.fields:
            test_util.TestUtil.verify_field(expected_type=aw.fields.FieldType.FIELD_BIDI_OUTLINE, expected_field_code=' BIDIOUTLINE ', expected_result='', field=field_bidi_outline)
