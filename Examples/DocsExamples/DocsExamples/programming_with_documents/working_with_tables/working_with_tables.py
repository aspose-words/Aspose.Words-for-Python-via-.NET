...
class WorkingWithTables(DocsExamplesBase):
    ...
    def test_remove_column(self):
        ...
        #GistId:212655df045ed6557d6a9b8ea875d8e9
    ...
    def test_auto_fit_table_to_contents(self):
        ...
        #GistId:cc27d25b7638915607d1d60373c08da9
        doc = aw.Document(MY_DIR + "Tables.docx")
    ...
    def test_clone_complete_table(self):
        ...
        #GistId:daa15d229a9e8b9015aa87ff6893f387
        doc = aw.Document(MY_DIR + "Tables.docx")
    ...
    def test_combine_rows(self):
        ...
        #ExStart:CombineRows
        #GistId:58600aa383a4cba01a02603683e30fd3
        doc = aw.Document(MY_DIR + "Tables.docx")
    ...
    def test_split_table(self):
        ...
        #ExStart:SplitTable
        #GistId:d31be78b25b463dd4eb31c85c60fc549
        doc = aw.Document(MY_DIR + "Tables.docx")
    ...
    def test_check_cells_merged(self):
        ...
        #GistId:b89ea9092bd2486dc056818cf4f73e24
    ...
    def test_get_table_position(self):
        ...
        #GistId:1768d04dbe9222138611d5ad4047beef
        doc = aw.Document(MY_DIR + "Tables.docx")
